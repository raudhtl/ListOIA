      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-2 mb-3">
            <ul class=" nav d-sm-flex flex-column  nav-pills" id="v-pills-tab"  role="tablist" aria-orientation="vertical">
            ...
            <div class="tab-content" id="v-pills-tabContent">
              <div id="uploads" role="tabpanel" class="tab-pane fade in active">
                <ul class="nav nav-tabs">
                  <li  id="0" class="active"><a data-toggle="tab" href="#tabs-0" style="pointer-events: none;">Mahasiswa</a></li>
                  <li id="1"  class="disabled"><a href="#tabs-1" style="pointer-events: none;">Program</a></li>
                  <li id="2" class="disabled"><a href="#tabs-2" style="pointer-events: none;">Dokumen</a></li>
                </ul>
                  ...
                  <div class="tab-content">
                    <div id="tabs-0" class="tab-pane fade in active">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="no_passport" class="form-control" id="no_passport" required>
                      </div>
                      <div class="form-group">
                        <label for="jurusan_asal">Jurusan Asal:</label>
                        <input type="text" name="jurusan_asal" class="form-control" id="juruan_asal" required>
                      </div>
                      <div class="form-group">
                        <label for="fakultas_asal">Fakultas Asal:</label>
                        <input type="text" name="fakultas_asal" class="form-control" id="fakultas_asal" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="univ_tujuan" class="form-control" id="univ_tujuan" required>
                      </div>
                      <div class="form-group">
                      ...
                      <a onclick="nextTab('1')" type="button" href="#" class="btn btn-primary">next</a>
                      </div>
                        ...
                        <div class="form-group">
                          <label for="program">Program :</label>
                            <select id="program" name="program" class="form-control" onchange="CheckProgram(this.value);" required  >
                              ...
                              <input type="text" name="p" placeholder="Masukkan nama program :" class="form-control" id="edit_program" required style="display:none">
                        </div>
                        <div class="form-group">
              ...
              <div id="excel" role="tabpanel" class="tab-pane fade in active">
                ...
                <form id="import_form" method="post" action="<?php echo base_url("index.php/Short_term/form"); ?>" enctype="multipart/form-data">
                  <div class="form-group">
                ...
                <div class="alert alert-danger fade in" id="alert" style="display:none">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Info! Terdapat cell kosong pada file yang Anda upload. Silahkan pilih file lain!</strong>
                </div>
    ...
    $(document).ready(function(){
        ...
        $('#import_form').on('submit', function(event){
          ...
          if($('#ton').val() == "submit"){
            alert("tes")
            $.ajax({
              url:"<?php echo base_url("index.php/Short_term/insert_excel"); ?>",
              method:"POST",
            ...
            $("#body").empty();
            $.ajax({
              url:"<?php echo base_url("index.php/Short_term/read"); ?>",
              method:"POST",
              data:new FormData(this),
              contentType:false,
              cache:false,
