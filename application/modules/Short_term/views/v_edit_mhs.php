<div class="col-12 align-items-center">
  		<div id="upload"  role="tabpanel"  class="card tab-pane fade show active">
  			...
  			<div class="card-body">
  				<form id="form_st_update" method="post" enctype="multipart/form-data"
  					action="<?php echo base_url('index.php/Student_Exchange/update_mhs'); ?>">
  					<div class="tab-content" id="myTabContent">
  						<div class="tab-pane fade show active" id="tabs-0" role="tabpanel"
  							aria-labelledby="data-mahasiswa">
  							<div class="tab-content" id="v-pills-tabContent">
                                <input type="text" name="id_mhs"  readonly = "readonly" class="form-control" id="id_mhs" style="display:none">
                                <input type="text" name="id_program"  readonly = "readonly" class="form-control" id="id_program" style="display:none">
  								<div class="form-group">
  									<label for="nama" >Nama:</label>
  									<input type="text" name="nama"  readonly = "readonly" class="form-control" id="nama">
  								</div>
  								<div class="form-group">
								...
								<div class="form-group">
  								...
  								<div class="form-group">
  									...
  									<input type="text" name="jurusan_asal" class="form-control" id="jurusan_asal">
  								</div>
  								<div class="form-group">
  						...
  						<div class="tab-pane fade" id="tabs-1" role="tabpanel" aria-labelledby="data-program">
                            ...
                            <div class="form-group">
  								...
  								<select disabled id="jenis_program" name="jenis_program" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <select disabled id="tujuan_kunjungan" name="tujuan_kunjungan" class="form-control" required>
  							...
  							<div class="form-group">
  								...
  								<input disabled type="text" name="tahun" id="tahun" placeholder="Masukkan tahun program :"
  									class="form-control">
  							</div>
                            <div class="form-group">
  								<label for="semester">Semester :</label>
  								<select disabled id="semester" name="semester" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="date" name="tgl_mulai" id="tgl_mulai"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="tgl_akhir">Tanggal Akhir :</label>
                                <input disabled type="date" name="tgl_akhir" id="tgl_akhir"
                                       class="form-control">
                            </div>
