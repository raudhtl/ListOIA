<div class="col-12 align-items-center">
  <div class = "card-body">
    ...
    <div class="col-sm-4">
      ...
      <a class="menu-app-2"   data-id = "list" data-val="Short_term/list">Daftar Mahasiswa</a>
      </div>
    </div>
    <div class="col-sm-4">
      <div class = "menu-1 text-uppercase "  id="add"  >
      <a class="menu-app-2"  data-id = "add"   data-val="Short_term/upload">Tambah Mahasiswa</a>
    </div>
    </div>
    <div class="col-sm-4" >
