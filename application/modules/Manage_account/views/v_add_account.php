<div class="col-12 align-items-center">
	<div class="row">
		<div class="col-10">
			<div class="card-body">
				<form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('index.php/Manage_account/'); ?>">
					<div class="form-group">
						<label for="program">Program :</label>
						<input type="text" name="program" placeholder="<?php echo $fakultas; ?>" class="form-control" readonly="readonly" value="<?php echo $fakultas; ?>">
					</div>
					<div class="form-group">
