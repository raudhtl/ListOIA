<div class="col-12 align-items-center">
  	...
  	<div class="tab-content vertical-center" id="v-pills-tabContent">
  		<div id="upload"  role="tabpanel"  class="card tab-pane fade show active">
  			...
  			<div class="card-body">
  				<form id="form_se" method="post" enctype="multipart/form-data"
  					...
  					<div class="tab-content" id="myTabContent">
  						<div class="tab-pane fade show active" id="tabs-0" role="tabpanel"
  							...
  							<div class="tab-content" id="v-pills-tabContent">
								...
								<div class="form-group">
									<label for="jurusan_asal">Jurusan Tujuan:</label>
									<input type="text" name="jurusan_tujuan" class="form-control" id="juruan_asal">
								</div>
								<div class="form-group">
									<label for="jurusan_asal">Fakultas Tujuan:</label>
									<input type="text" name="fakultas_tujuan" class="form-control" id="juruan_asal">
								</div>
  								<div class="form-group">
  						...
  						<div class="tab-pane fade" id="tabs-1" role="tabpanel" aria-labelledby="data-program">
  							...
  							<div class="form-group">
  								...
  								<input type="text" name="tahun" placeholder="Masukkan tahun program :"
  									class="form-control">
  							</div>
                            <div class="form-group">
  						...
  						<div class="tab-pane fade" id="tabs-2" role="tabpanel" aria-labelledby="data-dokumen">
							...
							<div class="form-group">
								<label for="file">Masukkan Scan Recommendation :</label>
								<input type="file" name="dokumen3" class="form-control">
							</div>
							<div class="form-group">
								<label for="file">Masukkan Surat Tugas :</label>
								<input type="file" name="dokumen4" class="form-control">
							</div>
							<div class="form-group">
								<label for="file">Masukkan Scan Transkrip Nilai :</label>
								<input type="file" name="dokumen5" class="form-control">
							</div>
							<div class="form-group">
								<label for="file">Masukkan Scan Insurance :</label>
								<input type="file" name="dokumen6" class="form-control">
							</div>
