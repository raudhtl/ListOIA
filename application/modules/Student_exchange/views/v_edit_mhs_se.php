<div class="col-12 align-items-center">
  		<div id="upload"  role="tabpanel"  class="card tab-pane fade show active">
  			...
  			<div class="card-body">
  				<form id="form_se_update" method="post" enctype="multipart/form-data"
  					...
  					<div class="tab-content" id="myTabContent">
  						<div class="tab-pane fade show active" id="tabs-0" role="tabpanel"
  							...
  							<div class="tab-content" id="v-pills-tabContent">
                                <input type="text" name="id"  readonly = "readonly" class="form-control" id="id" style="display:none">
                                ...
                                <div class="form-group">
                                    <label for="jurusan_tujuan">Jurusan Tujuan:</label>
                                    <input type="text" name="jurusan_tujuan" class="form-control" id="jurusan_tujuan">
                                </div>
                                <div class="form-group">
                                    <label for="fakultas_tujuan">Fakultas Tujuan:</label>
                                    <input type="text" name="fakultas_tujuan" class="form-control" id="fakultas_tujuan">
                                </div>
  								<div class="form-group">
