  					...
  					<div class="tab-content" id="myTabContent">
  						...
  						<div class="tab-pane fade" id="tabs-2" role="tabpanel" aria-labelledby="data-dokumen">
							...
							<div class="form-group">
								...
								<input type="file" name="dokumen3" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="file">Masukkan Surat Tugas :</label>
								<input type="file" name="dokumen4" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="file">Masukkan Scan Transkrip Nilai :</label>
								<input type="file" name="dokumen5" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="file">Masukkan Scan Insurance :</label>
								<input type="file" name="dokumen6" class="form-control" required>
							</div>
